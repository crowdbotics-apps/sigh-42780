"""
Django settings for sigh_42780 project.
...
WSGI_APPLICATION = 'sigh_42780.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sigh_42780 API",
    "DESCRIPTION": "API documentation for sigh_42780 App",
    "VERSION": "v1",
}
